      ...
      <el-row>
        ...
        <el-col :span="24">
          <el-form-item label="模板下载">
            <a href="http://localhost/dev-api/park/upload/excel/carinfo.xls">点击下载Excel模板</a>
          </el-form-item>
        </el-col>
        <el-col :span="24">
...
<script>
import { parsefile } from '@/api/sys/car'
import { getToken } from '@/utils/auth'
export default {
  data() {
    return {
      uploadUrl: process.env.VUE_APP_BASE_API + '/sys/car/excelUpload/',
      headers: {
        token: getToken()
      },
      visible: false,
