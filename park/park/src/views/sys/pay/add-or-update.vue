      ...
      <el-row>
        ...
        <el-col :span="24">
          <el-form-item label="状态" prop="status">
            <el-select v-model="dataForm.status" placeholder="请选择状态" filterable style="width: 100%">
        ...
        <el-col :span="24">
          <el-form-item label="类型" prop="type">
            <el-select v-model="dataForm.type" placeholder="请选择类型" filterable style="width: 100%">
