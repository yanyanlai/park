      ...
      <el-row>
        <el-col :span="24">
          <el-form-item label="停车场" prop="parkId">
            <el-select v-model="dataForm.parkId" placeholder="请选择小区" filterable style="width: 100%">
              <el-option v-for="park in parkList" :key="park.parkId" :label="park.parkName" :value="park.parkId" />
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :span="9">
          <el-form-item label="车牌识别" style="margin: 0;">
        ...
        <el-col :span="3" style="height: 200px;display: flex; justify-content: center;align-items: center;flex-wrap: wrap;">
          ...
          >
            <el-button size="small" type="primary">上传车牌</el-button>
          </el-upload>
        </el-col>
...
<script>
import { parkList, add } from '@/api/sys/inOut'
export default {
  data() {
    return {
      visible: false,
