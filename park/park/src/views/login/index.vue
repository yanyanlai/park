  ...
  <div class="login-container">
    <el-row>
      <el-col :xs="14" :sm="14" :md="14" :lg="24" :xl="24">
        <el-form style="opacity: 0.93" ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" autocomplete="on" label-position="left">
          <div class="title-container">
            <h3 class="title">智能停车场管理平台</h3>
          </div>
...
.login-container {
  min-height: 102%;
  width: 100%;
  background: url(~@/assets/images/2.png) no-repeat center fixed;
